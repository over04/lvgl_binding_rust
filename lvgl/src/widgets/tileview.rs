use lvgl_base::obj::{LvObj, LvObjPtr};
use lvgl_base::typing::dir::DirSelector;
use lvgl_macro::lvgl_obj;
use lvgl_sys::{lv_tileview_add_tile, lv_tileview_set_tile, lv_tileview_set_tile_by_index};
